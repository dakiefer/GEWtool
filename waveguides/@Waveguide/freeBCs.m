...
% bottom BCs:
op.L0(gdofBC1, gdofs1) = 0; op.L1(gdofBC1, gdofs1) = B0l1; 
op.L2(gdofBC1, gdofs1) = B1l1; op.M(gdofBC1, gdofs1) = 0;
% top BCs:
op.L0(gdofBC2, gdofs2) = 0; op.L1(gdofBC2, gdofs2) = B0l2; 
op.L2(gdofBC2, gdofs2) = B1l2; op.M(gdofBC2, gdofs2) = 0;
